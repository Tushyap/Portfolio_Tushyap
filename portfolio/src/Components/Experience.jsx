...
const Experience = () => {
  ...
  const globalLogicAssociate = [
    ...
    "Develop the new functionality and features as per the requirement also maintain the documentation.", "Troubleshoot and fixed bugs and issues to ensure smooth operation of the applications.", "Coordinate with team and discuss technical problems, bugs and report the daily status to Reporting Manager."
  ]
  ...
  const eceraSystem = [
    "Designed and developed a E-Learning web application which provides courses similar to Udemy, Coding Ninjas.", "Designed and developed dynamic and responsive webapps using MERN - React.js, JavaScript, HTML, CSS.",
            ...
            <List>
              {globalLogicAssociate.map((responsibility) => {
                return (
                  ...
                  >
                    <TbPoint style={{ minWidth: "20px", color: colors.greenAccent[300], }} />
                    <ListItemText sx={{ color: colors.grey[200], }} primaryTypographyProps={{
                      fontSize: 16,
                      fontWeight: 'initial',
                      letterSpacing: 0,
                    }}
